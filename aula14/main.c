...
int main()
{
    ...
    printf("[3] Relatorio 2: Pesquisar/Exibir os Dados de um Aluno por sua Matr�cula (XXX).\n");
    printf("[4] Relatorio 3: Exibir os dados ordenados por Matr�cula.\n");
    printf("[5] Relatorio 4: Pesquisar/Exibir os Dados de um Aluno por sua Matr�cula (XXX).\n");
        ...
        else if(opcao == 3)
        {
            ...
            else
            {
               ...
               else
               {
                  ...
                  if(output == -1)
                  {
                      printf("Matricula: %i n�o localizada na pauta dos alunos.\n", matPesquisa);
                  }
                  else
                  {
